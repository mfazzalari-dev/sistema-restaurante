...
* **Inteligência de Negócios:** Cálculo automático de faturamento e métricas de desempenho com gráficos interativos.
...
* **Front-end:** HTML5, CSS3 (Responsivo), JavaScript (Chart.js)
* **Gerenciamento:** Maven
