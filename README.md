...
👉 **[Acesse aqui o sistema](https://sistema-restaurante-zhcp.onrender.com)**
...
```bash
# Clone o repositório
git clone [https://github.com/mfazzalari-dev/sistema-restaurante.git](https://github.com/mfazzalari-dev/sistema-restaurante.git)
